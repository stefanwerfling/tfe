...
export class Utils {
     ...
     * @param str
     */
    public static base58Decode(str: string): number {
    ...
    public static buffer_wrapper(size_or_array: number|any, encoding?: BufferEncoding): Buffer {
        let result;
     ...
     */
    public static bufferConcat(arrayOfBuffers: Buffer[]): Buffer {
        let newBufferSize = 0;
        let targetStart = 0;
